...
class Themes {
  static ThemeData lightTheme = ThemeData(
      ...
      textSelectionTheme: const TextSelectionThemeData(cursorColor: defaultAppWhiteColor),
      ...
      floatingActionButtonTheme: FloatingActionButtonThemeData(backgroundColor: defaultAppColor4),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    floatingActionButtonTheme: const FloatingActionButtonThemeData(backgroundColor: defaultAppColor),
    sliderTheme: const SliderThemeData(
      inactiveTickMarkColor: Colors.transparent,
      activeTickMarkColor: Colors.transparent,
    ),
    ...
    toggleButtonsTheme: const ToggleButtonsThemeData(
        selectedBorderColor: Colors.transparent, borderColor: Colors.transparent, fillColor: Colors.transparent),
  );
}
